...
try {
  console.clear();
  p2.intro(`${import_picocolors2.default.bgCyan(import_picocolors2.default.black(" better-commits-init "))}`);
  ...
  p2.log.success(`${import_picocolors2.default.green("Successfully created .better-commits.json")}`);
  p2.outro(`Run ${import_picocolors2.default.bgBlack(import_picocolors2.default.white("better-commits"))} to start the CLI`);
} catch (err) {
  p2.log.error(`${import_picocolors2.default.red("Could not determine git root folder. better-commits-init must be used in a git repository")}`);
}
